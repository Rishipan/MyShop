...
class EditStockPage extends StatefulWidget {
  ...
  const EditStockPage({
    ...
    required this.units,
    required this.sellPerUnit,
    required this.description,
    required this.unitsBefore,
  });
...
class _EditStockPageState extends State<EditStockPage> {
  ...
  late final TextEditingController stockNameController;
  late final TextEditingController stockPriceController;
  late final TextEditingController unitsController;
  late final TextEditingController sellPriceController;
  late final TextEditingController descriptionController;
  late final TextEditingController unitsBeforeController;
  ...
  void initState() {
    ...
    stockNameController = TextEditingController(text: widget.stockName);
    stockPriceController =
        TextEditingController(text: widget.stockPrice.toString());
    unitsController = TextEditingController(text: widget.units.toString());
    sellPriceController =
        TextEditingController(text: widget.sellPerUnit.toString());
    descriptionController = TextEditingController(text: widget.description);
    unitsBeforeController =
        TextEditingController(text: widget.unitsBefore.toString());
  }
  ...
  _saveStockToFirestore() async {
    ...
    try {
      ...
      if (barcodeQuery.docs.isNotEmpty) {
        ...
        int existingUnits = (existingStock['units_before'] ?? 0);
